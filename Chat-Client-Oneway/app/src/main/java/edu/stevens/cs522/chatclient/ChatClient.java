...
//  private DatagramSocket clientSocket;
	...
	public void onClick(View v) {
		try {
			...
			Log.d(TAG, String.valueOf(clientName.length()));
			if (clientName.length() > 0) {
				...
				String line = clientName + ": " + messageText.getText().toString();
				...
				Toast toast= Toast.makeText(getApplicationContext(),
						"Enter Chat Name", Toast.LENGTH_SHORT);
				toast.setGravity(Gravity.CENTER|Gravity.CENTER_HORIZONTAL, 0, 0);
				toast.show();

//				Toast.makeText(getApplicationContext(),"Enter Chat Name",Toast.LENGTH_SHORT).show();
			}
